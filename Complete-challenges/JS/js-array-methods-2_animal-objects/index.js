...
const weightLessThanAHundred = allAnimalsInEuropeWeighLessThanOnehundred.every(
  (animal) => animal.weight < 100
);
console.log("weightLessThanAHundred: ", weightLessThanAHundred);
