...
const allCardsWithTagsHTMLOrJSThatAreBookmarked = cards.filter((card) => {
  // return card.includes("html" || "js") && card.isBookmarked === true;
  return (
...
// console.log(onlyCardWithIdTwo, allCardsWith3Tags, allCardsThatAreNotBookmarked, allCardsWithTagsHTMLOrJSThatAreBookmarked);
